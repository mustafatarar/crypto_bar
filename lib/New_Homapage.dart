           ...
           Container(
                    ...
                    child: 
                            ...
                            Row(
                              ...
                              Padding(padding: EdgeInsets.only(left: 20,top: 6),child: 
                       ...
                       child:
                        ...
                        Column(
                         ...
                         children: [
                           ...
                           decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage('assets/images/grp (4).png') )
                           ),
                           ),
                    ...
                    child:
                      Container(
                       ...
                       child:
                        ...
                        Container(height: 45,width: 45,
                           decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage('assets/images/grp (1).png') )
                           ),
                           ),
                           Text(
                       ...
                       child:
                        ...
                        Column(
                         ...
                         children: [
                           ...
                           Container(height: 45,width: 45,
                           decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage('assets/images/grp (2).png') )
                           ),
                           ),
                           Text(
  'Send a receive rent',
                       ...
                       child:
                        ...
                        Column(
                         ...
                         children: [
                            ...
                            Container(height: 45,width: 45,
                           decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage('assets/images/grp (3).png') )
                           ),
                           ),
