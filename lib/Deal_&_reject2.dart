...
class DealAndRejectTwo extends StatefulWidget {
 

  @override
  _DealAndRejectTwoState createState() => _DealAndRejectTwoState();
}

class _DealAndRejectTwoState extends State<DealAndRejectTwo> {
  String _chosenValue;
    String date = "";
