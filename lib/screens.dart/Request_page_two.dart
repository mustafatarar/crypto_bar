...
class RequestPageTwo extends StatefulWidget {
 

  @override
  _RequestPageTwoState createState() => _RequestPageTwoState();
}

class _RequestPageTwoState extends State<RequestPageTwo> {
  String _chosenValue;
  @override
        ...
        children: [
          Padding(padding: EdgeInsets.only(left: 12)),
           DropdownButton<String>(
             ...
             underline: SizedBox(),
              iconSize: 0.0,
             hint: Padding(padding: EdgeInsets.only(left: 10,right: 10),child: 
             Row(
...
Padding(padding: EdgeInsets.only(left: size.width*0.5150),child: 
Row(
...
GestureDetector(
  onTap: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>USDAmount()));
  },
  child: 
