...
import 'package:cryptoapp/screens.dart/login_screens/keep_in_touch.dart';
import 'package:cryptoapp/screens.dart/login_screens/signin.dart';
import 'package:flutter/material.dart';

class SafeAndSecure extends StatefulWidget {
  

  @override
  _SafeAndSecureState createState() => _SafeAndSecureState();
}

class _SafeAndSecureState extends State<SafeAndSecure> {
  @override
...
Text(
  ...
  style: TextStyle(
    ...
    color: Color(0xffFFFFFF)
     ...
     Padding(padding: EdgeInsets.only(top: size.height*0.160,left: size.width*0.470),child:  
 Container(
   height: 13,
   width: 13,
 ...
 Image(image: AssetImage('assets/images/sec.png'),
 
          height: 162,
          width: 105,
          ),
          Padding(padding: EdgeInsets.only(top: size.height*0.020,right: size.width*0.550),child:  
 Container(
   height: 20,
   width: 20,
...
GestureDetector(
  onTap: (){
     Navigator.push(context, MaterialPageRoute(builder: (context)=>KeepInTouce()));
  },
  child: 
