...
class USDAmount extends StatefulWidget {


  @override
  _USDAmountState createState() => _USDAmountState();
}

class _USDAmountState extends State<USDAmount> {
    String _chosenValue;
  @override
...
Padding(padding: EdgeInsets.only(left: size.width*0.650),child: 
Row(
