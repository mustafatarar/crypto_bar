      ...
      body: SingleChildScrollView(
        ...
        children: [
          Column(
            children: [
              Padding(
                padding: EdgeInsets.only(top: 50, left: size.width * 0.030),
                child: Text(
                  'Recent',
                  style: TextStyle(
                      fontFamily: 'Poppins',
          ...
          Padding(
              padding: EdgeInsets.only(
                  top: 30, left: size.width * 0.030, right: size.width * 0.030),
              child: Row(
          ...
          Padding(
              padding: EdgeInsets.only(
                  top: 20, left: size.width * 0.030, right: size.width * 0.020),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(
          ...
          Padding(
              padding: EdgeInsets.only(
                  top: 10, left: size.width * 0.030, right: size.width * 0.020),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(
          ...
          Center(
            ...
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => BuYCoins()));
            },
            child: Padding(
