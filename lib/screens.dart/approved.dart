...
import 'package:cryptoapp/property%20&%20Buyer/UploadInfopageone.dart';
...
import 'package:cryptoapp/screens.dart/Pay_desposit_two.dart';
...
GestureDetector(
  onTap: (){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>PayDepositTwo()));
  },
  child: 
